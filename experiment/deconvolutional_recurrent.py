...
class DeConvRNN2D(RNN):
  ...
  def __init__(self,
    ...
    super(DeConvRNN2D, self).__init__(cell,
                                    return_sequences,
                                    return_state,
                                    go_backwards,
                                    stateful,
  ...
  def compute_output_shape(self, input_shape):
    ...
    if cell.data_format == 'channels_first':
      ...
      rows = input_shape[2]
      cols = input_shape[3]
    rows = conv_utils.deconv_output_length(rows,
                                         cell.kernel_size[0],
                                         padding=cell.padding,
                                         stride=cell.strides[0],
                                         dilation=cell.dilation_rate[0])
    cols = conv_utils.deconv_output_length(cols,
                                         cell.kernel_size[1],
                                         padding=cell.padding,
...
class DeConvLSTM2DCell(DropoutRNNCellMixin, Layer):
  """Cell class for the DeConvLSTM2D layer.
  ...
  def __init__(self,
               ...
               recurrent_dropout=0.,
               **kwargs):
    super(DeConvLSTM2DCell, self).__init__(**kwargs)
  ...
  def input_conv(self, x, w, b=None, padding='valid'):
    conv_out = backend.conv2d_transpose(x, w, output_shape=self.original_input_shape, strides=self.strides,
                              padding=padding,
  ...
  def recurrent_conv(self, x, w):
    conv_out = backend.conv2d_transpose(x, w, output_shape=self.original_input_shape, strides=(1, 1),
                              padding='same',
                              data_format=self.data_format)
    return conv_out
  ...
  def get_config(self):
    ...
    base_config = super(DeConvLSTM2DCell, self).get_config()
    return dict(list(base_config.items()) + list(config.items()))


# @keras_export('keras.layers.DeConvLSTM2D')
class DeConvLSTM2D(DeConvRNN2D):
  ...
  def __init__(self,
               ...
               recurrent_dropout=0.,
               **kwargs):
    cell = DeConvLSTM2DCell(filters=filters,
    ...
    super(DeConvLSTM2D, self).__init__(cell,
  ...
  def call(self, inputs, mask=None, training=None, initial_state=None):
    return super(DeConvLSTM2D, self).call(inputs,
                                        mask=mask,
                                        training=training,
  ...
  def get_config(self):
    config = {'filters': self.filters,
              ...
              'dropout': self.dropout,
              'recurrent_dropout': self.recurrent_dropout}
    base_config = super(DeConvLSTM2D, self).get_config()
